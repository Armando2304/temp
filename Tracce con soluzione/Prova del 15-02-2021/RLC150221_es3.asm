;Sia dato un vettore di word V contenente informazioni riguardanti le temperature massime e minime rilevate in n città. Dunque, sia V un vettore di dimensione 2*n in cui ciascun elemento in posizione pari contiene la temperatura minima in una certa città e l’elemento immediatamente successivo contiene la temperatura massima rilevata nella stessa città. Scrivere una procedura Assembly che calcola e restituisce un vettore di word W formato da due elementi e costruito come segue: 
;
